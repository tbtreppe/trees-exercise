...
class BinaryTree {
  ...
  minDepth() {
    ...
    function minHelp(node) {
      ...
      if (node.right === null) return minHelp(node.right) + 1;
  ...
  maxDepth() {
    ...
    function maxHelp(node) {
      ...
      if (node.right === null) return maxHelp(node.right) + 1;
  ...
  maxSum() {
    ...
    function sumHelp(node) {
      ...
      const leftSum = sumHelp(node.left);
      const rightSum = sumHelp(node.right);
